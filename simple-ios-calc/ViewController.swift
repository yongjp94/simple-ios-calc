...
//  simple-ios-calc
//
//  Created by Yongjun Park on 10/24/17.
...
class ViewController: UIViewController {
    ...
    @IBAction func operatorPressed(op: UIButton!){
        ...
        switch opPressed{
        case 0:
            performOperation(op: Operations.Add)
        case 1:
            performOperation(op: Operations.Subtract)
        case 2:
            performOperation(op: Operations.Divide)
        case 3:
            performOperation(op: Operations.Multiply)
        default:
            print("No Operations")
        }
    ...
    @IBAction func equalsPressed(btn: UIButton!){
        ...
        performOperation(op: Operations.None)
    }
